...
import IconBtn from "@/components/global/icon-btn";
...
const SearchInput: React.FC<SearchInputProps> = ({setFilter,filter,placeholder}) => {

    return (
        <div className="border flex-item pl-2 rounded-md">
            <div className="w-5">
